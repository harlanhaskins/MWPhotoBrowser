...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        [_selectedButton setImage:MWImage(@"ImageSelectedSmallOff.png") forState:UIControlStateNormal];
        [_selectedButton setImage:MWImage(@"ImageSelectedSmallOn.png") forState:UIControlStateSelected];
...
- (void)showImageFailure {
    if (!_loadingError) {
        ...
        _loadingError.image = MWImage(@"ImageError.png");
